...
import { FileText, CheckCircle, Copy, Download, X, Loader2, Plus, TrendingUp } from 'lucide-react';
          ...
          <div className="p-6 space-y-6">
            ...
            {showPreview && selectedResume && (
              <div className="mb-4">
                ...
                {previewMode === 'split' && (
                  <div className="split-view flex gap-4 h-[600px]">
                ...
                {previewMode === 'full' && (
                  <div className="flex justify-center h-[800px] bg-white rounded-xl overflow-hidden">
                    {selectedResume && (
                      <iframe 
                ...
                {previewMode === 'preview' && (
                  <div className="flex justify-center h-[600px]">
                    <div className="panel w-2/3 max-w-xl bg-white rounded-xl overflow-hidden">
                      {selectedResume && (
                        <iframe 
            ...
            {selectedResume && !showPreview && (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                transition={{ type: 'spring', stiffness: 400, damping: 30 }}
                className="h-[600px] bg-white rounded-xl overflow-hidden shadow-2xl"
              >
                <iframe 
